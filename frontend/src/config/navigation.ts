...
export const navItems: NavItem[] = [
  {
    ...
    group: 'public',
    audiences: ['guest', 'student', 'runner', 'goodsPublisher', 'shopMerchant', 'admin', 'tradeAdmin', 'showcaseAdmin', 'masterAdmin'],
    icon: 'HomeFilled',
    mobileTab: 'always',
  },
  {
  ...
  },
  {
    ...
    group: 'account',
    audiences: ['student', 'runner', 'goodsPublisher', 'shopMerchant', 'admin', 'tradeAdmin', 'showcaseAdmin', 'masterAdmin'],
    icon: 'User',
    requiresAuth: true,
  },
  {
  ...
  },
  {
    path: '/roles',
    label: '身份解锁',
    description: '申请跑腿、二手发布者、店铺商家和领域管理员身份',
    group: 'account',
    audiences: ['student', 'runner', 'goodsPublisher', 'shopMerchant', 'admin', 'tradeAdmin', 'showcaseAdmin', 'masterAdmin'],
    icon: 'Key',
    requiresAuth: true,
  },
  {
    ...
    group: 'workspace',
    audiences: ['goodsPublisher', 'admin', 'masterAdmin'],
    icon: 'CirclePlus',
    requiresAuth: true,
  ...
  },
  {
    ...
    group: 'workspace',
    audiences: ['shopMerchant', 'admin', 'masterAdmin'],
    icon: 'Management',
    requiresAuth: true,
  ...
  },
  {
    path: '/admin/trade',
    label: '交易管理',
    description: '管理跑腿任务、二手商品和售后纠纷',
    group: 'admin',
    audiences: ['tradeAdmin', 'masterAdmin'],
    icon: 'Tickets',
    requiresAuth: true,
    requiredRole: 'tradeAdmin',
  },
  {
    path: '/admin/showcase',
    label: '展示管理',
    description: '管理项目广告、学生店铺和服务纠纷',
    group: 'admin',
    audiences: ['showcaseAdmin', 'masterAdmin'],
    icon: 'Shop',
    requiresAuth: true,
    requiredRole: 'showcaseAdmin',
  },
  {
    path: '/admin/ops',
    label: '运营数据',
